...
np.save('/home/lac/datos_modelo/z_altura{}_{}_wnan_yx.npy'.format(altura,dias[0]),z_expanded)      # Guarda nuevamente el archivo .npy (se va sobreescribiendo el archivo con los nuevos valores)

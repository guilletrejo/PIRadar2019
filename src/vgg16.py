...
umbral = 0.3
x_train_dir = home + "/datos_modelo/24horas/umbral{}/X_Train.npy".format(umbral)
x_val_dir = home + "/datos_modelo/24horas/umbral{}/X_Val.npy".format(umbral)
y_train_dir = home + "/datos_lluvia/24horas/umbral{}/Y_Train.npy".format(umbral)
y_val_dir = home + "/datos_lluvia/24horas/umbral{}/Y_Val.npy".format(umbral)
model_dir = home + "/modelos/CerroObero/24horas/umbral{}/epoca{epoch:02d}.hdf5".format(umbral)
cant_epocas = 30
